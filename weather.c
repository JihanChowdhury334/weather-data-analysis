...
//Yearly Averages Question 1
            int index = year - START_YEAR;
            yearly_sum[index] += temperature;
            yearly_count[index]++;
            
 //Century Averages Question 2
...
//Hottest month and coldest month Question 4
...
//Hottest month and coldest month Question 4
    ...
    // Write the yearly averages to a text file
 ...
 // Track hottest and coldest years Question 5
    ...
    // Write the century averages to a text file
	...
	// Write the monthly averages to a text file
    ...
    // Write the yearly averages to a text file(1950-2015)
    FILE *yearly_q8__file = fopen("question_8_yearly_averages.txt", "w");
    if (yearly_q8__file == NULL) {
        fprintf(stderr, "Error opening yearly averages file.\n");
        return 1;
    }
    /*fprintf(yearly_q8__file, "Year\tAverage Temperature\n");*/
